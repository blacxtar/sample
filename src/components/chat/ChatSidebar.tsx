...
const ChatSidebar = ({ isOpen, onToggle, currentChatId, onNewChat, onSelectChat }: ChatSidebarProps) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 h-full overflow-auto w-64 z-50 transform transition-transform duration-300 ease-in-out 
      ...
      `}>
        <div className="h-screen bg-chat-sidebar border-r border-chat-border flex flex-col">
          ...
          <div className="flex-1 px-2">
            <h3 className="text-sm font-medium text-muted-foreground mb-1">Chats</h3>
